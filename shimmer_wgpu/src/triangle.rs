...
impl From<ShadingMode> for ShadingModeU32 {
    fn from(value: ShadingMode) -> Self {
        match value {
            ShadingMode::Flat => ShadingModeU32::Flat,
            ShadingMode::Gouraud => ShadingModeU32::Gouraud,
        }
    }
}
